...
process parallel {
    ...
    script:
        ...
        Rscript CiPA/hERG_fitting/hERG_fitting.R -d $params.drugName -c $task.cpus -i $sample -l $params.population -t $params.accuracy > "fit_${params.drugName}_${sample}.txt"
        cp "fit_${params.drugName}_${sample}.txt" "${params.azureFileShare}/fit_${params.drugName}_${sample}.txt"
        """
}
